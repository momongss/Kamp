...
public class BF_SnowTerrain : MonoBehaviour
{
    ...
    private void UpdateTerrainData()
    {
        ...
        grassTerrainMaterial.SetVector("_TerrainScale", terrainData.size);


        grassTerrainMaterial.SetFloat("_IST", 1);
        grassTerrainMaterial.EnableKeyword("IS_T");
    ...
    public void MoveTerrainSync()
    {
        if (terrainToCopy != null && terrainToCopy != terrainAsset)
        {
            ...
            grassTerrainMaterial.SetFloat("_ISADD", 1);
            grassTerrainMaterial.EnableKeyword("IS_ADD");
        }
        else
        {
            //grassTerrainMaterial.SetFloat("_GrassCut", 0);
            grassTerrainMaterial.SetFloat("_ISADD", 0);
            grassTerrainMaterial.DisableKeyword("IS_ADD");
        }
    }
